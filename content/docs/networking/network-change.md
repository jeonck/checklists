...
## 1. Change definition and approval {#change-definition-and-approval}
...
## 2. Baseline capture {#baseline-capture}
...
## 3. Blast-radius assessment {#blast-radius-assessment}
...
## 4. Out-of-band access {#out-of-band-access}
...
## 5. Applying the change {#applying-the-change}
...
## 8. Closure and documentation {#closure-and-documentation}
