...
## 1. Source control and change flow {#source-control-and-change-flow}
...
## 3. Pipeline credentials and permissions {#pipeline-credentials-and-permissions}
...
## 4. Third-party actions and runners {#third-party-actions-and-runners}
...
## 6. Security scanning in the pipeline {#security-scanning-in-the-pipeline}
...
## 7. Artefact management and provenance {#artefact-management-and-provenance}
...
## 9. Pipeline reliability and maintenance {#pipeline-reliability-and-maintenance}
